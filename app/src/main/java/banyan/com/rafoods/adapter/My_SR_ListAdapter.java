...
import banyan.com.rafoods.activity.Activity_Primary_Order_Form;
...
public class My_SR_ListAdapter extends ArrayAdapter<Hero> {
    ...
    public My_SR_ListAdapter(Context context, int resource, List<Hero> heroList) {
